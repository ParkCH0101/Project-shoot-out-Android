function onCreatePost()
    ...
    makeLuaText('funScore', 'Score: 0            Misses: 0', getPropertyFromClass('flixel.FlxG', 'width'),
        getProperty('scoreTxt.x'), getProperty('scoreTxt.y'));
    setTextSize('funScore', 22);
    setTextBorder('funScore', 1, '000000');
    setTextAlignment('funScore', 'center');
    addLuaText('funScore');
end
